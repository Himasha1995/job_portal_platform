...
if (isset($_POST['upload'])) {
	...
	$sql = "INSERT INTO add_company (filename,company,email,address,jobtittle,about_us) VALUES ('$filename','$company','$email','$address','$jobtittle','$about_us')";
...
<head>
<a class="btn btn-danger" href="company_detals.php" role="button">Back</a><br>
...
<body>
	<div id="content">
      ...
      <div class="form-group">
			...
			<div class="form-group">
				<input class="form-control" type="text" name="jobtittle" value="" placeholder="job tittle" />
			</div>
			<div class="form-group">
				<input class="form-control" type="text" name="about_us" value="" placeholder="Company About" />
			</div>
			<div class="form-group">
