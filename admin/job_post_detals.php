...
<div class="container">
  <h1> Job Details</h1>
    ...
    ?>
     ...
     <div class="add_job">
     <a class="btn btn-primary" href="add_new_post.php" role="button">Add Job Post</a>
    </div><br>
  <div class="row">
    <div class="col-18">
        ...
        <thead>
          ...
          <tr>
            ...
            while($row = mysqli_fetch_assoc($result)){
              ...
              <td> <a href="details.php?id=<?php echo $row['id']?>" class="uil uil-file-check-alt" width="250" height="250"></a></td>
              <td>
